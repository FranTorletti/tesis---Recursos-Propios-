...
{block name="body"}
    ...
    <div id="table">
        ...
        <a href="{Router::url('/home/admin/dependence/delete/')}{$dependence->getId()}" class="btn btn-danger" 
        ...
        <form action="{Router::url('/home/admin/dependence/edit/')}{$dependence->getId()}" method="POST" enctype="multipart/form-data">
            <table class="table table-condensed">
                ...
                <tbody style="border-collapse:separate">
                    <tr class="success">
                        <td><label>Codigo</label></td>
                        <td><input name="code" type="text" value="{$dependence->getCode()}" onkeypress="return isNumberKey(event)" required></td>
                    </tr>
                    <tr class="success">
                        <td><label>Descripcion</label></td>
