...
{block name="body"}
        ...
        <table class="table table-condensed">
            ...
            <tbody style="border-collapse:separate">
                <tr class="success">
                    ...
                    <td>{$activityType->getCode()}</td>
                </tr>
                <tr class="success">
                    <td><label>Descripcion</label></td>
                    <td>{$activityType->getDescription()}</td>
                </tr>
                <tr class="success">
                    <td><label>Nota</label></td>
                    <td>{$activityType->getNote()}</td>
                </tr>
            </tbody>
        </table>
        <br>
    ...
    <div id="form" style="visibility:hidden;display:none">
        <form action="{Router::url('/home/admin/activityType/edit/')}{$activityType->getId()}" method="POST" enctype="multipart/form-data">
            <table class="table table-condensed">
                <thead>
                    <th></th>
                    <th></th>
